...
async def build_global_consciousness_v2(ctx: Any, user_id: str = "default_user") -> str:
    ...
    - Market: Prix, volumes, tendances, corrélations
    - Sentiment: Fear & Greed, news sentiment
    - Signals: Signaux bot de trading (RSI, MACD, etc.)
    - User context: Profil, positions, préférences
    - Opportunities: Détection automatique (DCA, swing, etc.)
    - Risks: Analyse des risques marché
    ...
    Returns:
        Résumé langage naturel pour LLM + stockage conscience complète
    """
...
def build_global_consciousness_v1_fallback(working: Dict[str, Any], new_event: Dict[str, Any] = None) -> str:
    ...
    Utilisée si erreur dans V2 pour garantir fonctionnement
...
"""
            ...
            # ========================================================================
            # LEGACY: Enrichir l'événement local pour working memory
            # ========================================================================
            enriched_summary = summary
            event_details = {}

            # Enrichir selon le type de données (pour backward compatibility)
