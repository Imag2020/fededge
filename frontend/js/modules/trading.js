...
export class TradingManager {
    ...
    showBotConfigModal() {
        ...
        if (modal) {
            console.log('[TradingManager] ✓ Modal found, opening...');
            ...
            console.error('[TradingManager] ✗ Modal bot-config-modal NOT FOUND in DOM');
    ...
    async loadBotConfig() {
        try {
            ...
            if (configDisplay) {
                ...
                console.warn('[TradingManager] ✗ current-bot-config element not found');
            }
        } catch (error) {
